      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <section className="w-full py-24 sm:py-32">
          ...
          <div className="text-center mb-16">
            ...
            <h2 className="text-xl sm:text-3xl lg:text-4xl font-black mb-8  bg-clip-text text-black dark:text-white leading-tight">
              {t("programs.title") || "Transform Your Future"}
            </h2>

            <p className="text-sm sm:text-base text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed font-normal">
              {t("programs.subtitle") ||
            ...
            {programs.map((program, index) => {
              ...
              return (
                ...
                >
                  {/* Card Container */}
                  <div
                    className={`relative overflow-hidden rounded-3xl sm:rounded-[3rem] transition-all duration-500 p-8 sm:p-12 lg:p-16 backdrop-blur-md ${
                      program.darkBg
                  ...
                  >
                    ...
                    <div
                      className={`absolute -top-32 -right-32 w-72 sm:w-96 h-72 sm:h-96 ${
                        program.lightGlowColor
                      } ${program.darkGlowColor} rounded-full blur-3xl ${
                        isHovered
                    ...
                    ></div>
                    <div
                      className={`absolute -bottom-32 -left-32 w-72 sm:w-96 h-72 sm:h-96 ${
                        program.lightGlowColor
                      } ${
                    ...
                    <div className="absolute top-8 right-8 sm:top-12 sm:right-12 z-20">
                      <div
                        className={`relative w-16 h-16 sm:w-28 sm:h-28 rounded-3xl sm:rounded-[2rem] shadow-xl ${
                          isHovered
                            ? "scale-100 rotate-12"
                            : "scale-100 rotate-3"
                      ...
                      >
                        ...
                        <div className="flex items-center justify-center h-full">
                          <span className="text-white font-black text-2xl sm:text-5xl drop-shadow-lg">
                            {program.number}
                          </span>
                        </div>
                    ...
                    <div className="relative z-10 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                      ...
                      >
                        ...
                        {/* Title */}
                        <h3 className="text-2xl sm:text-3xl lg:text-4xl font-black mb-6 bg-gradient-to-r from-gray-900 via-gray-700 to-gray-600 dark:from-white dark:via-primary-300 dark:to-primary-300 bg-clip-text text-transparent leading-tight">
                          {t(program.titleKey) || `Program ${program.id}`}
                        </h3>

                        {/* Description */}
                        <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 mb-12 leading-relaxed font-normal max-w-xl">
                          {t(program.descKey) ||
                        ...
                        <button
                          className={`inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r ${
                            program.buttonGradient
                          } text-white font-bold rounded-full hover:shadow-xl transition-all duration-300 transform ${
                            isHovered ? "scale-110 shadow-lg" : "scale-100"
                          } w-fit group/btn text-base uppercase tracking-wider`}
                        >
                        ...
                        <div className="relative w-full max-w-md">
                          ...
                          <div
                            className={`absolute inset-0 ${
                              ...
                              program.darkGlowColor
                            } rounded-[2rem] blur-3xl scale-125 ${
                              isHovered ? "scale-150" : ""
                          ...
                          <div className="relative rounded-2xl sm:rounded-[2rem] overflow-hidden transition-all duration-500 border-white dark:border-gray-700/50 hover:border-white/80 dark:hover:border-gray-600/80">
                            ...
                            <Image
                              ...
                              width={500}
                              height={500}
                              className={`w-full h-[400px] object-cover rounded-2xl sm:rounded-[2rem] ${
                                isHovered
