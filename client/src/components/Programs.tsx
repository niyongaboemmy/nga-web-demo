          ...
          <div className="">
            ...
            <div className="w-full px-3 py-8 md:p-8 md:px-3 mt-8">
              <div className="relative">
                ...
                <div className="space-y-8 md:space-y-12 sm:pl-5">
                  <div className="flex items-start">
                    <div className="flex-1 relative overflow-hidden bg-gradient-to-br from-primary-50 to-primary-100 dark:from-primary-900/20 dark:to-primary-800/20 min-h-[400px] rounded-3xl hover:-translate-y-3 ring-2 ring-primary-200/50 hover:ring-primary-400/50 transition-all duration-500 p-10 w-full backdrop-blur-sm">
                        ...
                        <div className="lg:ml-8">
                          <div className="relative">
                            ...
                            <Image
                              ...
                              width={320}
                              height={320}
                              className="relative w-80 h-80 rounded-3xl object-cover"
                            />
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="flex items-start">
                    <div className="flex-1 relative overflow-hidden bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 min-h-[400px] rounded-3xl hover:-translate-y-3 ring-2 ring-green-200/50 hover:ring-green-400/50 transition-all duration-500 p-10 w-full backdrop-blur-sm">
                  ...
                  <div className="flex items-start">
                    <div className="flex-1 relative overflow-hidden bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 min-h-[400px] rounded-3xl hover:-translate-y-3 ring-2 ring-orange-200/50 hover:ring-orange-400/50 transition-all duration-500 p-10 w-full backdrop-blur-sm">
                        ...
                        <div className="lg:ml-8">
                          <div className="relative">
                            ...
                            <Image
                              ...
                              width={320}
                              height={320}
                              className="relative w-80 h-80 object-cover rounded-3xl"
                            />
                          </div>
                        </div>
                      </div>
